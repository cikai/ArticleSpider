...
public class Util {
	...
	// 只匹配url
	public static ArrayList<ArticleBean> GetRecommendations(String content) {
		// 预定义一个ArrayList来存储结果
		ArrayList<ArticleBean> results = new ArrayList<ArticleBean>();
		...
		while (isFind) {
			// 定义一个知乎对象来存储抓取到的信息
			ArticleBean zhuhuTemp = new ArticleBean(urlMatcher.group(1));
			// 添加成功匹配的结果
